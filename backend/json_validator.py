...
def validate_and_format_json(json_data):
    try:
        ...
        answer_message = next(
            (message for message in messages if message.get("type") == "answer"), None
        )
        ...
        return False, f"Invalid JSON in file: {e}", None, None, None, None, None, None
    except KeyError:
        return (
            False,
        ...
        return False, f"An error occurred: {e}", None, None, None, None, None, None
